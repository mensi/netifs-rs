...
// copy of winapi::um::iptypes from git until it gets released to crates.io.
...
use winapi::shared::basetsd::{UINT8, ULONG64};
use winapi::shared::guiddef::GUID;

use crate::winapi_shared_ifdef::{
    IF_INDEX, IF_LUID, IF_OPER_STATUS, NET_IF_COMPARTMENT_ID, NET_IF_CONNECTION_TYPE,
    NET_IF_NETWORK_GUID, TUNNEL_TYPE
};
pub type IFTYPE = ULONG; //use winapi::shared::ipifcons::IFTYPE;
use winapi::shared::minwindef::{BOOL, BYTE, DWORD, UCHAR, UINT};

//use winapi::shared::nldef::{NL_DAD_STATE, NL_PREFIX_ORIGIN, NL_SUFFIX_ORIGIN};
...
use winapi::shared::ntdef::{CHAR, PCHAR, PWCHAR, ULONG, ULONGLONG, WCHAR};
